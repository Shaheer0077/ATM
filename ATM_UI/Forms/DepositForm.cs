...
namespace ATM_UI.Forms
{
    public class DepositForm : Form
    {
        ...
        private void BuildUI()
        {
            ...
            pnlDeposit.Controls.Add(lblBalance);

            // ================= AMOUNT FIELD =================
            Panel amountBg = CreateFieldBackground(70);
            pnlDeposit.Controls.Add(amountBg);
            ...
            pnlDeposit.Controls.Add(presetPanel);
            ...
            pnlDeposit.Controls.Add(btnDeposit);
            pnlDeposit.Controls.Add(btnCancel);
